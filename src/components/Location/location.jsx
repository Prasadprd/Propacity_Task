...
const Location =()=>{
    ...
    return (
        <div className="container-fluid location-container">
            ...
            <div className="row location-info d-none d-md-inline" >Strategically located at Rani  Baug,  Byculla, Piramal Realty’s Aranya brings world-class hospitals, academic institutions, IT and entertainment hubs closer to the residents. The upcoming Marine Drive 2.0 is further set to offer seamless connectivity to the Eastern Harbour and dining and art destinations.</div>
            <div className="row d-inline d-md-none" style={{font:"2vh poppins"}} >Strategically located at Rani  Baug,  Byculla, Piramal Realty’s Aranya brings world-class hospitals, academic institutions, IT and entertainment hubs closer to the residents. The upcoming Marine Drive 2.0 is further set to offer seamless connectivity to the Eastern Harbour and dining and art destinations.</div>
           
            <div className="row " style={{padding:"2% 15%"}}>
                <div className="row location-nearby">
                    {
                        nearbyEssentials_1.map(unit =>{
                            return <div className="col" key={unit} style={{display:"flex"}}><RiArrowRightSFill style={{color:"orange"}} /> <p>{unit}</p> </div>
                        })
                    }
                </div>
                <div className="row location-nearby">
